...
7.4  [done] Escrever testes de integração para complete_task
...
7.6  [done] Escrever testes para get_tasks com filtros
...
8.2  [done] Implementar command update_settings
...
8.4  [done] Implementar ThemeProvider com toggle funcional
...
10.6 [done] Implementar command get_tasks_by_date_range
...
11.3 [done] Implementar command get_streak
...
11.8 [done] Criar componente StreakCard
